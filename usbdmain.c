...
int joystick_val;   //track the current joystick value
int joystick_prev;  //track the previous value for the joystick
int back_flag;
...
void music_player (void)
{
  ...
  joystick_val = 0;   //track the current joystick value
	joystick_prev = 0;  //track the previous value for the joystick
	back_flag = 0;
	
	GLCD_Clear(White);
	GLCD_SetTextColor(Black);
	GLCD_DisplayString (2, 4, 1, "Music Player");
	GLCD_DisplayString (8, 0, 1, "Back to Main Menu");
